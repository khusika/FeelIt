...
Since [Markdown Render Hooks](https://gohugo.io/getting-started/configuration-markup#markdown-render-hooks) was introduced in the [Hugo Christmas Edition](https://gohugo.io/news/0.62.0-relnotes/) and some of image resources are using webp which was introduced in [0.83.0](https://github.com/gohugoio/hugo/releases/tag/v0.83.0), this theme only supports Hugo versions above **0.83.0**.
{{< /admonition >}}
